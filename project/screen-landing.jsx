// Landing page — hero + misconceptions carousel
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div className="num" style={{ fontSize: 22, fontWeight: 700, color: "var(--green-700)", lineHeight: 1 }}>
            {item.stat}
          </div>
...
function Landing({ onStart }) {
  ...
  const [scrollIdx, setScrollIdx] = useStateL(0);
  ...
  return (
    <div data-screen-label="00 Landing" style={{ display: "flex", flexDirection: "column", gap: 80 }}>
      {/* HERO */}
      ...
      <section>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 28, flexWrap: "wrap", gap: 16 }}>
          <div>
            ...
            <h2 className="h-title" style={{ margin: 0, maxWidth: 680 }}>
              你可能以為… 其實…
            </h2>
          </div>
...
function HeroVisual() {
  // Stylized isometric rooftop illustration built with CSS — placeholder, not photoreal
  return (
