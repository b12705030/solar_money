...
export const MISCONCEPTIONS: Misconception[] = [
  ...
  {
    myth: '颱風來了，屋頂光電板會被吹飛',
    truth: '新規上路後屋頂光電可抗17級強風，通過5,400 Pa耐風壓測試（≈每平方公尺550公斤），新建物須一體化設計預埋固定件、專業技師簽證、每2年強制定檢，安全標準比一般屋頂招牌更嚴格。',
    stat: '5,400 Pa',
    statLabel: '耐風壓測試標準',
    compare: '相當於抵抗17級陣風',
    statTip: '5,400 Pa 耐風壓 ≈ 每平方公尺承受約 550 公斤壓力。\n此標準相當於超高層建築（25層以上）高樓層的風壓等級，比一般屋頂招牌規範更嚴格。\n\n新建物屋頂光電4大安全升級：\n✔ 耐風：通過5,400 Pa耐風壓測試，可抗17級陣風\n✔ 穩固：一體化設計預埋固定件，防止二次施工破壞防水層\n✔ 安全：設置前須專業技師結構簽證，每2年強制定檢\n✔ 韌性：停電時仍可隔離市電、供電予建物，支援社區微電網\n\n資料來源：經濟部能源署 2026-06-10 公告',
  },
];
